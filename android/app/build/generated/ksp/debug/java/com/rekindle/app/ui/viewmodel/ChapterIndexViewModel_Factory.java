...
public final class ChapterIndexViewModel_Factory implements Factory<ChapterIndexViewModel> {
  ...
  public ChapterIndexViewModel_Factory(Provider<SavedStateHandle> savedStateHandleProvider,
  ...
  public static ChapterIndexViewModel_Factory create(
    ...
    return new ChapterIndexViewModel_Factory(savedStateHandleProvider, repoProvider, downloadRepoProvider, prefsProvider);
  }

  public static ChapterIndexViewModel newInstance(SavedStateHandle savedStateHandle,
      MediaRepository repo, DownloadRepository downloadRepo, PrefsStore prefs) {
    return new ChapterIndexViewModel(savedStateHandle, repo, downloadRepo, prefs);
  }
}
